...
class SQL_request:
    ...
    def write_insert_i2b2_data(self, dic_data):
        ...
        if dic_data['table'] == 'patient_dimension':
            ...
            request = 'INSERT INTO i2b2demodata.observation_fact (patient_num, encounter_num, startdate, concept_cd, tval_char, nval_num, import_date, modifier_cd, instance_num, sourcesystem_cd, provider_id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
        return request
